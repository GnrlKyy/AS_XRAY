...
echo -e "${GB}————————————————————————————————————————————————————————${NC}"
echo -e ""
echo -e " ${GB}[1]${NC} ${WB}Create Account All Xray${NC} "
echo -e " ${GB}[2]${NC} ${WB}Trial Account All Xray${NC} "
echo -e " ${GB}[3]${NC} ${WB}Extend Account All Xray${NC} "
echo -e " ${GB}[4]${NC} ${WB}Delete Account All Xray${NC} "
